	...
	*/
	...
	class searchView extends View {
		...
		public function base() {
			$this->title("The Ultimate Book Search");
			$this->add('{
				"css" : [ "/public/style/home.css" ],
				"js" : [ "/public/javascript/home.js" ]
			}');
		...
		public function book() {
			$search_term = htmlspecialchars(stripslashes($this->get("search_term")));

			$this->title("Searching \"" . $search_term . "\" at The Ultimate Book Search");
			$this->add('{
				"css" : [ "/public/style/home.css" ],
				"js" : [ "/public/javascript/home.js" ]
			}');
